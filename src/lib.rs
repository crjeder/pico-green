...
// This is based on https://github.com/rp-rs/rp-hal-boards/blob/main/boards/rp-pico/src/lib.rs

//! A Hardware Abstraction Layer for the Raspberry Pi Pico Clock Green by WaveShare.
//!
